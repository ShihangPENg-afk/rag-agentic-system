...
@app.get("/documents/", response_model=DocumentsListResponse, summary="获取最近上传的文档")
async def get_documents(limit: int = Query(default=50, ge=1, le=200)):
...
@app.get("/qa_logs/", response_model=QALogsListResponse, summary="按知识库查询历史问答")
